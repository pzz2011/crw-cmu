...
int main(int argc, char** argv)
{
  ...
  cv::WImageBuffer3_b image( cvLoadImage("20110806_082034.jpg", CV_LOAD_IMAGE_COLOR) );
  ...
  while (nh.ok()) 
  {
  	ROS_INFO("%d", counter);
		if (counter == 1)
		  cv::WImageBuffer3_b image( cvLoadImage("20110805_032305.jpg", CV_LOAD_IMAGE_COLOR) );
		if (counter == 2)
			cv::WImageBuffer3_b image( cvLoadImage("20110805_032305.jpg", CV_LOAD_IMAGE_COLOR) );
		if (counter == 3)
			cv::WImageBuffer3_b image( cvLoadImage("20110805_032305.jpg", CV_LOAD_IMAGE_COLOR) );
